...
public class New_MiddleCategory2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_middle_category2);
        ...
        back_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(New_MiddleCategory2.this, MiddleCategory2.class);
                New_MiddleCategory2.this.startActivity(intent);
            }
        });
        TextView title_toolbar = findViewById(R.id.title_toolbar_rtl);
        title_toolbar.setText("ایجاد دسته بندی میانی دوم جدید");
        //toolbar end
        ...
        if (pic_reader.getString("Editable?", "nothing to show").equals("yes")) {
            if (address.getString("is_edit", "nothing").equals("true")) {
                edit_ads();
                title_toolbar.setText("ویرایش دسته بندی میانی دوم");
        ...
        send_cat_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (address.getString("is_edit", "nothing").equals("true")) {
                    ...
                    volley.connect(New_MiddleCategory2.this, "activity_category", "update", true, cat_id_edt.getText().toString(), pic_category, title_edt.getText().toString(), id,"1");

                } else if (pic_reader.getString("Editable?", "nothing to show").equals("yes")) {
                    volley.connect(New_MiddleCategory2.this, "activity_category", "update", true, cat_id_edt.getText().toString(), pic_category, title_edt.getText().toString(), id,"1");
                    //    Log.i("mohsenjamali", "onClick: 2");
                } else {
                    volley.connect(New_MiddleCategory2.this, "activity_category", "send", true, cat_id_edt.getText().toString(), pic_category, title_edt.getText().toString(), id,"1");
    ...
    private void edit_ads() {
        ...
        Glide.with(New_MiddleCategory2.this)
