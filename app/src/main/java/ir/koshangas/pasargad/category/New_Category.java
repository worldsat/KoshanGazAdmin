package ir.koshangas.pasargad.category;
        ...
        send_cat_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (address.getString("is_edit", "nothing").equals("true")) {
                    ...
                    volley.connect(New_Category.this, "activity_category", "update",false, "", pic_category, title_edt.getText().toString(), id,"");

                } else if (pic_reader.getString("Editable?", "nothing to show").equals("yes")) {
                    volley.connect(New_Category.this, "activity_category", "update", false,"", pic_category, title_edt.getText().toString(), id,"");
                    //    Log.i("mohsenjamali", "onClick: 2");
                } else {
                    volley.connect(New_Category.this, "activity_category", "send",false, "", pic_category, title_edt.getText().toString(), id,"");
...
// Add all other intents
    ...
    public void onRequestPermissionsResult(int requestCode, String permissions[], int[] grantResults) {
        if (mCropImageUri != null && grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
            ...
            intent.putExtra("page", "activity_category");
            save_cash();
